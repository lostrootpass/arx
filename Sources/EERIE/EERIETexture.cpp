...
void EERIE_ActivateBump(void)
{
	...
	if (g_pRenderApp)
	{
		...
		if (deviceInfo->wNbBlendStage > 2 && deviceInfo->wNbTextureSimultaneous > 1)
		{
			//bump 1pass
			if (deviceInfo->dwTextureOpCaps & D3DTEXOPCAPS_DOTPRODUCT3)
			{
				//dot
			...
			{
				if (deviceInfo->dwTextureOpCaps & D3DTEXOPCAPS_ADDSIGNED)
				{
					//addsigned
